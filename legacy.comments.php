...
<?php if ('open' == $post->comment_status) : ?><br/><br/><br/>

<p><b>Tell us what you're thinking... <br/>and oh, if you want a pic to show with your comment, go get a <a
		href="http://en.gravatar.com">gravatar</a>!</b></p>
...
<?php if (get_option('comment_registration') && !$user_ID) : ?>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<p><input type="text" name="name" id="name" value="<?php echo $comment_author; ?>" size="22"
